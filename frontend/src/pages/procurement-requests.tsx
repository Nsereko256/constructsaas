...
export function ProcurementRequestsPage() {
  ...
  const primaryAction = (request: PurchaseRequest) => {
    ...
    if (canEdit) return <Button size="sm" variant="secondary" className="pr-next-action" onClick={() => setEditingDraft(request)}><Pencil size={13} />Edit draft</Button>;
