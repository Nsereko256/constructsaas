    ...
    <div className="purchase-requests-reference">
      ...
      <section className="pr-workspace-grid">
        <div data-pagination-region className="pr-queue-panel">
          ...
          </tbody></table>{!requestRows.length ? <p className="pr-empty">{requests.isLoading ? 'Loading material requests…' : 'No material requests match this view.'}</p> : null}</TableScroll>
