...
export function FinanceMonthEndPage() {
  ...
  const checkLinks: Record<string, string> = { unmatched_grns: '/procurement/grns', unmatched_invoices: '/finance/payables?status=SUBMITTED', pending_payments: '/finance/payments?status=SUBMITTED', unreconciled_cash: '/finance/reconciliation?status=UNRECONCILED' };
