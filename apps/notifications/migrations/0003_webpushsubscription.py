    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='web_push_subscriptions', to='accounts.company')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['company', 'user'], name='webpush_company_user_idx'),
        ),
    ]
